...
A creator does not merely recommend a product. She shows people how she uses a complete list, routine, recipe, or household system—and why it works for her circumstances.

Examples:

- A vegan family’s weekly groceries, pantry staples, recipes, and substitutions
- A household managing celiac disease
- A teacher’s classroom setup and replenishment list
- A first-time mother’s newborn routine
- A family-of-six laundry system
- A caregiver’s recurring supplies and schedule

The useful unit is not the affiliate link. It is the transferable experience surrounding it.
...
A person should be able to find a household system that resembles their life, save it, adapt it, and send its lists into the shopping and delivery services they already use.

The platform should never require one retailer, one affiliate network, one social platform, or one AI provider. Lists and household knowledge must remain portable.

## Core principles

- Knowledge before commerce
- Systems before products
- Creators are partners, not inventory
...
- [`docs/00-non-negotiables.md`](docs/00-non-negotiables.md)
- [`docs/01-product-thesis.md`](docs/01-product-thesis.md)
- [`docs/02-platform-model.md`](docs/02-platform-model.md)
- [`docs/03-fable-context.md`](docs/03-fable-context.md)
